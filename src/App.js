...
const App = () => {
  const [movies, setMovies] = useState([
    ...
    { id: 9, titre: "Inception", description: "Un voleur d'informations plonge dans les rêves pour voler des secrets.", posterURL: "/images/Inception.jpg", note: "9", trailerUrl:"https://www.youtube.com/watch?v=YoHD9XEInc0" }, 
